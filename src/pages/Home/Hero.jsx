...
import SliderImg1 from '../../assets/type-entertainment-complex-popular-resort-with-pools-water-parks-turkey-luxury-hotel-resort.jpg'
import SliderImg2 from '../../assets/maldives-island.jpg'
    ...
    return (
        <div>
            ...
            >
                <SwiperSlide>
                    <div
                        className="hero h-[400px] lg:min-h-screen bg-object-cover"
                        style={{
                            objectFit: "cover",
                        ...
                        <div className="hero-content text-neutral-content text-center">
                            <div className=" text-white">
                                <h1 className="mb-5 text-6xl  font-bold">Maldives Luxery Resorts</h1>
                ...
                <div
                        ...
                        <div className="hero-content text-neutral-content text-center">
                            <div className="text-white">
                                <h1 className="mb-5 text-6xl  font-bold">panhandle of Florida</h1>
                                <p className="mb-5 px-10">
                ...
                <SwiperSlide>
                <div
                        className="hero h-[400px] lg:min-h-screen"
                        style={{
                        ...
                        <div className="hero-content text-neutral-content text-center">
                            <div className="text-white">
                                <h1 className="mb-5 text-6xl  font-bold">The Colosseum, Italy</h1>
                                <p className="mb-5 px-10">
                ...
                <div
                        ...
                        <div className="hero-content text-neutral-content text-center">
                            <div className="text-white">
                                <h1 className="mb-5 text-6xl  font-bold">Kyoto, Japan. 
                                </h1>
                                <p className="mb-5 px-10">
                ...
                <div
                        ...
                        <div className="hero-content text-neutral-content text-center">
                            <div className="text-white">
                                <h1 className="mb-5 text-6xl  font-bold">Mananggu Beach, Indonesia.</h1>
                                <p className="mb-5 px-10">
