    ...
    return (
        <div className="lg:flex gap-16 items-center pt-20 w-[95%] mx-auto">
            <div className=" text-center lg:text-start">
                <h1 className="text-3xl md:text-4xl lg:text-5xl font-serif">Want To Know More About Us ?</h1>
                ...
                <motion.button
                    ...
                    whileTap={{ scale: 0.99 }}
                    className="px-10 py-3 rounded-full border-2 border-[#1a73e8] text-[#1a73e8] font-semibold hover:bg-[#1a73e8] hover:text-white">Join Our Community</motion.button>
            </div>
            <div>
