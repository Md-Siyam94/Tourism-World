...
const JoinCommunity = () => {
    return (
        <div className="flex gap-16 items-center py-20 w-[95%] mx-auto">
            <div className="">
                <h1 className="text-3xl md:text-4xl lg:text-6xl font-extralight text-info">Want To Know More About Us ?</h1>
