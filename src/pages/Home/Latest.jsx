    ...
    return (
        <div className='max-w-7xl py-20'>
            <div className='w-[90%] lg:w-[50%] text-center mx-auto'>
                <h1 className=' text-3xl lg:text-5xl font-serif'><span className='font-semibold'>Get</span> The Latest News
                ...
                <Link to={"https://github.com/Md-Siyam94"}><button className="px-10 py-3 rounded-full border-2 border-[#1a73e8] text-[#1a73e8] font-semibold hover:bg-[#1a73e8] hover:text-white">Subscribe</button></Link>
            </div>
            <div>
